/**
 * Catatan Kontrakan - SVG Icons
 * Feather-style consistent icons
 */
...
const icons = {
    ...
    history: `<svg viewBox="0 0 24 24"><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="10"/></svg>`,

    wallet: `<svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>`,
    ...
    arrowDownLeft: `<svg viewBox="0 0 24 24"><line x1="17" y1="7" x2="7" y2="17"/><polyline points="17 17 7 17 7 7"/></svg>`,
    ...
    // Content
    megaphone: `<svg viewBox="0 0 24 24"><path d="M3 11l18-5v12L3 13v-2z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg>`,
...
function getCategoryIcon(category) {
    const map = {
        'Listrik': icons.zap,
        'Air': icons.droplet,
        'Keamanan & Kebersihan': icons.shield,
        'Titip Makanan': icons.coffee,
        'Lainnya': icons.package
    };
    return map[category] || icons.package;
}
